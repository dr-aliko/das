...
urlpatterns = [
    ...
    path('student/<int:student_id>/denemeler/export/', views.coach_student_exam_export, name='student_exam_export'),
    path('student/<int:student_id>/denemeler/topics/', views.coach_student_topics_partial, name='student_exam_topics'),
    ...
    path('student/<int:student_id>/chart-data/', views.coach_student_chart_data, name='student_chart_data'),
    path('student/<int:student_id>/brans/', views.brans_hub_coach, name='student_brans_hub'),
    path('student/<int:student_id>/brans/api/', views.brans_hub_coach_api, name='student_brans_hub_api'),
    path('student/<int:student_id>/brans/ekle/', views.coach_brans_create_for_student, name='student_brans_create'),
    path('student/<int:student_id>/brans/report/', views.brans_hub_export_coach, name='student_brans_hub_export'),
    path('student/<int:student_id>/brans/<slug:subject_slug>/report/', views.brans_subject_export_coach, name='student_brans_subject_export'),
    path('student/<int:student_id>/brans/<slug:subject_slug>/', views.brans_subject_detail_coach, name='student_brans_subject_detail'),
    path('student/<int:student_id>/brans/<slug:subject_slug>/api/', views.brans_subject_detail_coach_api, name='student_brans_subject_detail_api'),
